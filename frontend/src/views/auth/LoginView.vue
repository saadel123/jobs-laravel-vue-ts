...
<template>
    <v-container class="fill-height d-flex align-center justify-center">
        <v-card class="mx-auto auth-card pa-6" width="600" elevation="4">
            <v-card-title class="text-center py-8">
                <v-icon size="48" color="green-darken-2 account-circle" class="mr-3">mdi-account-circle</v-icon>
            ...
            <v-card-text class="px-6 pb-6">
                ...
                <v-btn block @click="login" color="green-darken-2" :loading="isLoading" :disabled="isLoading" size="x-large"
